...
from models import InterviewSession, InterviewTurn, QuestionBank, UserSkillState
from gemini_helpers import score_answer, maybe_generate_followup
...
def process_answer(
    ...
    from models import QuestionHistory, JobSpec
