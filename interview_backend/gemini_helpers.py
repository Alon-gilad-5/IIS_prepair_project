...
# Add parent directory to path to import CV improvement services
sys.path.insert(0, str(Path(__file__).parent.parent))
from cv_improvement_services.gemini_client import call_gemini_json


# Note: This function is not currently used.
# The interview backend uses call_gemini_json() from cv_improvement_services.gemini_client
# which uses gemini-2.5-pro as specified in the requirements.
def get_gemini_model():
    """Get configured Gemini model (unused - interview uses call_gemini_json instead)."""
    # This function is kept for reference but not used.
    # All Gemini calls go through call_gemini_json() which uses gemini-2.5-pro
    pass
